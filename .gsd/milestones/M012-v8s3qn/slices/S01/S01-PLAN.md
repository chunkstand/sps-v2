...
- [ ] **T01: EmergencyRecord and OverrideArtifact ORM models + migration** `est:1h`
...
- [ ] **T02: POST /api/v1/emergencies endpoint with 24h max duration** `est:1h`
...
- [ ] **T03: POST /api/v1/overrides endpoint with scope validation** `est:1h`
...
- [ ] **T04: Override guard in apply_state_transition activity** `est:2h`
...
- [ ] **T05: EMERGENCY_HOLD state transitions in workflow** `est:1.5h`
...
- [ ] **T06: Integration tests for override guard enforcement** `est:1.5h`
...
- [ ] **T07: Integration tests for EMERGENCY_HOLD transitions** `est:1h`
...
- [ ] **T08: Docker-compose runbook for full emergency/override lifecycle** `est:2h`
