...
def get_case_jurisdiction(
    case_id: str,
    limit: int = Query(default=_DEFAULT_LIST_LIMIT, ge=1),
    db: Session = Depends(get_db),
) -> JurisdictionResolutionListResponse:
    bounded_limit = _clamp_list_limit(limit)
    try:
        ...
        rows = (
            ...
            .order_by(
                JurisdictionResolution.created_at.desc(),
                JurisdictionResolution.jurisdiction_resolution_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
    ...
    try:
        ...
        rows = (
            ...
            .order_by(
                ...
                ComplianceEvaluation.compliance_evaluation_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_incentives(
    ...
    try:
        ...
        rows = (
            ...
            .order_by(
                IncentiveAssessment.assessed_at.desc(),
                IncentiveAssessment.incentive_assessment_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
    ...
    try:
        ...
        attempts = (
            ...
            .order_by(
                ...
                SubmissionAttempt.submission_attempt_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_external_status_events(
    ...
    try:
        ...
        rows = (
            ...
            .order_by(
                ExternalStatusEvent.received_at.desc(),
                ExternalStatusEvent.event_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_manual_fallbacks(
    ...
    try:
        ...
        packages = (
            ...
            .order_by(
                ManualFallbackPackage.created_at.desc(),
                ManualFallbackPackage.manual_fallback_package_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_correction_tasks(
    ...
    try:
        ...
        tasks = (
            ...
            .order_by(
                CorrectionTask.created_at.desc(),
                CorrectionTask.correction_task_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_resubmission_packages(
    ...
    try:
        ...
        packages = (
            ...
            .order_by(
                ResubmissionPackage.created_at.desc(),
                ResubmissionPackage.resubmission_package_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
    ...
    try:
        ...
        records = (
            ...
            .order_by(
                ...
                ApprovalRecord.approval_record_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
...
def get_case_inspection_milestones(
    ...
    try:
        ...
        milestones = (
            ...
            .order_by(
                InspectionMilestone.created_at.desc(),
                InspectionMilestone.inspection_milestone_id.desc(),
            )
            .limit(bounded_limit)
            .all()
        )
