...
async def _run_integration() -> None:
    ...
    try:
        ...
        await handle.signal(
            ...
            ReviewDecisionSignal(
                decision_outcome=ReviewDecisionOutcome.APPROVE,
        ...
        assert isinstance(result, ReviewDecisionSignal)
        assert result.decision_outcome == ReviewDecisionOutcome.APPROVE
